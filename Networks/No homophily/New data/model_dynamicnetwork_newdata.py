...
class ConsumatModel(Model):
    def __init__(self, config):
        ...
        # Load the datasets
        self.income_distribution = pd.read_csv("/Users/isabelklennert/Library/Mobile Documents/com~apple~CloudDocs/Thesis/datasets/Adjusted_Distribution_of_spendable_income_2022.csv")
        self.processed_df = pd.read_csv('/Users/isabelklennert/Library/Mobile Documents/com~apple~CloudDocs/Thesis/datasets/processed_dutch_population.csv')
